...
namespace Nebx.Labs.Integrations.Email.Extensions;

/// <summary>
/// Provides extension methods for converting application-level email models
/// into <see cref="MimeMessage"/> instances compatible with MimeKit.
/// </summary>
/// <remarks>
/// These helpers bridge between custom email abstractions and the MimeKit
/// types required for SMTP transmission, MIME formatting, and client
/// interoperability.
/// </remarks>
