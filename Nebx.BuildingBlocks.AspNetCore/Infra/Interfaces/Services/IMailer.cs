...
public interface IMailer
{
    ...
    /// </summary>
    /// <param name="message">
    /// The <see cref="EmailMessage"/> object containing sender, recipients, subject, body, and attachments.
    /// </param>
    ...
    /// </param>
    /// <returns>
    /// A <see cref="Task"/> representing the asynchronous connection check operation.
    /// </returns>
