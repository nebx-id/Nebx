...
using ICommand = Nebx.BuildingBlocks.AspNetCore.Mediator.Abstractions.ICommand;

namespace Nebx.BuildingBlocks.AspNetCore.Mediator.Implementation;

/// <inheritdoc />
public sealed class LiteBusMediator : IMediator
{
    ...
    /// <inheritdoc />
    public async Task<TResult> Send<TResult>(Abstractions.IQuery<TResult> query,
    ...
    /// <inheritdoc />
    public async Task<TResult> Send<TResult>(Abstractions.ICommand<TResult> command,
        CancellationToken cancellationToken = default)
        => await _commandMediator.SendAsync(command, cancellationToken);
